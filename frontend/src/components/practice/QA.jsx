  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-3xl mx-auto pb-10">
      ...
      <div className="text-center space-y-2 mb-8 pt-4">
        <h1 className="font-display font-bold text-3xl dark:text-zinc-100 light:text-zinc-900">
          Q&A Reader
        </h1>
      ...
      <div className="space-y-6">
        {questions.map((q, index) => (
          <div key={q.id} className="card p-5 sm:p-6 space-y-4 shadow-sm">
            ...
            <div className="flex justify-between items-center border-b dark:border-zinc-800 light:border-amber-200 pb-3">
              <span className="text-xs font-display font-semibold text-gold uppercase tracking-wide">
                Question {index + 1}
              </span>
              <span className="text-xs dark:text-zinc-500 light:text-zinc-400 font-body">
                Week {q.week}
              </span>
            </div>

            {/* Question Text */}
            <p className="font-body text-base sm:text-lg font-medium dark:text-zinc-100 light:text-zinc-900 leading-relaxed">
              {q.question}
            </p>
                  ...
                  <div 
                    ...
                    className={`px-4 py-3 rounded-xl text-sm border font-body leading-relaxed flex items-start gap-2
                      ${isCorrect 
                        ...
                        : 'dark:border-zinc-800 light:border-amber-100 dark:bg-zinc-800/30 light:bg-amber-50/50 dark:text-zinc-400 light:text-zinc-500'
                      }`}
                  >
            ...
            {/* Explanation Block */}
            <div className="mt-4 pt-4 border-t dark:border-zinc-800 light:border-amber-200">
              <p className="text-xs font-display font-semibold text-gold mb-2 uppercase tracking-wide">
                Explanation
              </p>
              <p className="text-sm dark:text-zinc-300 light:text-zinc-600 font-body leading-relaxed">
                {q.explanation}
              </p>
            </div>
